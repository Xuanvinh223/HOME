<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/DefaultMasterPage.master" CodeFile="Leave_ListHR.aspx.cs" Inherits="WKF_Leave_ListHR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <contenttemplate>
            ...
            <Ede:Grid ID="gvLeave" runat="server" CssClass="gdLeave" PageSize="10" AllowPaging="True" DataKeyNames="LYV" AutoGenerateColumns="False" AutoGenerateCheckBoxColumn="True" CustomDropDownListPage="False" DataKeyOnClientWithCheckBox="True" DefaultSortDirection="Ascending" EmptyDataText="No data found" EnhancePager="True" KeepSelectedRows="False" SelectedRowColor="229, 245, 159" UnSelectedRowColor="238, 238, 238" ShowHeaderWhenEmpty="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnBeforeExport="gvLeave_BeforeExport" OnRowDataBound="gvLeave_RowDataBound" OnPageIndexChanging="gvLeave_PageIndexChanging" OnSelectedIndexChanging="gvLeave_SelectedIndexChanging" OnSorting="gvLeave_Sorting" AllowSorting="True" Width="100%">
                ...
                <columns>
                    <asp:TemplateField HeaderText="Số&lt;br/&gt;單號" SortExpression="LYV">
                        <edititemtemplate>
