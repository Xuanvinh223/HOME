...
public class WebServiceLYN  : System.Web.Services.WebService {
    ...
    [WebMethod]
    public string CheckBusinessTripExpert(string formInfo)
    {
        ...
        try
        {
            string Name_ID = xmlDoc.SelectSingleNode("/Form/FormFieldValue/FieldItem[@fieldId='Form']/LYN_BusinessTripExpert_Form").Attributes["Name_ID"].Value.ToString();
            string Type = xmlDoc.SelectSingleNode("/Form/FormFieldValue/FieldItem[@fieldId='Form']/LYN_BusinessTripExpert_Form").Attributes["Type"].Value.ToString();
            string Agent_ID = xmlDoc.SelectSingleNode("/Form/FormFieldValue/FieldItem[@fieldId='Form']/LYN_BusinessTripExpert_Form").Attributes["Agent_ID"].Value.ToString();
            string Purpose = xmlDoc.SelectSingleNode("/Form/FormFieldValue/FieldItem[@fieldId='Form']/LYN_BusinessTripExpert_Form").Attributes["Purpose"].Value.ToString();
            string FLocation = xmlDoc.SelectSingleNode("/Form/FormFieldValue/FieldItem[@fieldId='Form']/LYN_BusinessTripExpert_Form").Attributes["FLocation"].Value.ToString();
            string Journey = xmlDoc.SelectSingleNode("/Form/FormFieldValue/FieldItem[@fieldId='Form']/LYN_BusinessTripExpert_Form").Attributes["Journey"].Value.ToString();
            string Days = xmlDoc.SelectSingleNode("/Form/FormFieldValue/FieldItem[@fieldId='Form']/LYN_BusinessTripExpert_Form").Attributes["Days"].Value.ToString();
