...
public partial class WKF_BusinessTripExpert_Reports : Ede.Uof.Utility.Page.BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            rd.Load(Server.MapPath("~/CDS/LYN/Plugin/Report/rptBusinessTripExpert.rpt"));
            ...
            //crvBusinessTripExpert.ReportSource = rd;
