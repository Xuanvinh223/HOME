...
using Ede.Uof.WebApi.M.ViewModels.EIP;

public partial class LYN_ListAcceptanceFA : Ede.Uof.Utility.Page.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            string status = Drflowflag.SelectedValue;

            LoadGridView(LNO, RKNO, type, startDate, endDate, status);
    ...
    private void LoadGridView(string LNO, string RKNO, string ListType,string Sdate,string Edate,string status)
    {
        LYN.AcceptanceFA.UCO.AcceptanceFAUCO uco = new LYN.AcceptanceFA.UCO.AcceptanceFAUCO();
        DataTable dt = uco.GetGridView_Close(LNO, RKNO, ListType, Sdate, Edate, status);
    ...
    {
        LoadGridView(tbLNO.Text, tbRKNO.Text, DrListType.SelectedValue, userdate_start.Text, userdate_end.Text, Drflowflag.SelectedValue);
