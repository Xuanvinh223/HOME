...
public partial class LYN_Supplier_Reports : Ede.Uof.Utility.Page.BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            rd.Load(Server.MapPath("~/CDS/LYN/Plugin/Report/rptSupplier.rpt"));
