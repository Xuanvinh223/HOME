...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <div class="container mt-5">
            <table class="table tblTotal table-bordered">
                <tr>
                    <td style="width: 620px">
                        <b>Số phiếu đơn xin đặt mua | 請購單單號</b>
                        <br />
                        <asp:TextBox ID="tbPurchaseRequestNo" AutoPostBack="True" runat="server" MaxLength="20" Style="width: 550px" CssClass="form-control" />
                    </td>
                    <td style="width: 600px">
                        <b>Số phiếu đơn đặt mua | 採購單單號</b>
                        <br />
                        <asp:TextBox ID="tbZSNO" runat="server" Style="width: 550px" Enabled="false" CssClass="form-control" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 620px">
                        <b><span style="color: red;">*</span> Số phiếu nhập kho | 入庫單單號</b>
                        <br />
                        <asp:TextBox ID="tbRKNO" runat="server" OnTextChanged="tbRKNO_Changed" AutoPostBack="True" Style="width: 550px;" CssClass="form-control" />
                    </td>
                    <td style="width: 600px">
                        <b>Nhà cung ứng | 廠商</b>
                        <br />
                        <asp:TextBox ID="tbZSYWJC" runat="server" Style="width: 550px" Enabled="false" CssClass="form-control" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <Ede:Grid ID="gvMaster" runat="server" CssClass="table table-hover table-striped FormGrid" PageSize="20" AllowPaging="True" DataKeyNames="RKNO" AutoGenerateColumns="False" AutoGenerateCheckBoxColumn="True" CustomDropDownListPage="False" DataKeyOnClientWithCheckBox="True" DefaultSortDirection="Ascending" EmptyDataText="No data found" EnhancePager="True" KeepSelectedRows="False" SelectedRowColor="229, 245, 159" UnSelectedRowColor="238, 238, 238" ShowHeaderWhenEmpty="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDataBound="gvMaster_OnRowDataBound" OnPageIndexChanging="gvMaster_PageIndexChanging" AllowSorting="True" Width="100%">
