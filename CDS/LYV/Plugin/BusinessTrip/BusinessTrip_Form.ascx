            ...
            <div class="container">
                ...
                <asp:Panel ID="Dep" runat="server" Visible="false">
                    <div class="mb-3">
                        ...
                        <div class="mt-3">
                            <asp:GridView ID="gvDep" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="5" OnPageIndexChanging="gvDep_PageIndexChanging" CssClass="FormGrid" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvDep_SelectedIndexChanged" AutoPostBack="true" OnRowDataBound="gvDep_RowDataBound">
                ...
                <div class="row mb-3">
                    ...
                    <!-- Đơn vị -->
                    <div class="col-md-4">
                        <label for="Name_DepID" class="form-label">
                            <b>Đơn vị 部門 </b>
                        </label>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <label for="Agent" class="form-label">
                            <b>Họ tên người thay thế 職務代理人</b>
                        </label>
                ...
                <div class="row mb-4">
                    <!-- Thời gian bắt đầu -->
                    <div class="col-md-4">
                        <label for="BTime" class="form-label">
                            <b>
                                <label class="text-danger">* </label>
                            Bắt đầu 自</b>
                        </label>
                    ...
                    <!-- Thời gian kết thúc -->
                    <div class="col-md-4">
                        <label for="ETime" class="form-label">
                            <b>
                                <label class="text-danger">* </label>
                            Kết thúc 至</b>
                        </label>
                ...
                <div class="row mb-3">
                    ...
                    <!-- Phương tiện khác -->
                    <div class="col-md-6">
                        <label for="ptkhac" class="form-label">
                            <b>Mô tả phương tiện khác 其他</b>
                        </label>
                ...
                <!-- Xe công ty -->
                <div class="row mb-3">
                    <label for="ApplyCar" class="form-label">
                        <b>Xe công ty 公司派車</b>
                    </label>
                ...
                <div class="row mb-3">
                    <label for="Remark" class="form-label">
                        <b>Ghi rõ nguyên nhân đi máy bay, thuyền 搭乘飛機 、船舶原因請詳細詿明</b>
                    </label>
