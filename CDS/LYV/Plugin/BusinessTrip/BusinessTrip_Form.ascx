        ...
        <form class="form-horizontal">
            <div class="container">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <label for="Agent" class="form-label"><b>Họ tên người thay thế</b></label>
                        <asp:TextBox ID="Agent" runat="server" MaxLength="50" CssClass="form-control" Enabled="false" />
                    </div>

                    <!-- Tài liệu kèm theo -->
                    <div class="col-md-4">
                        <label for="documents" class="form-label"><b>Tài liệu kèm theo</b></label>
                ...
                <div class="row mb-4">
                    ...
                    <!-- Số ngày -->
                    <div class="col-md-4">
                        <label for="Days" class="form-label"><b>Số ngày</b></label>
                ...
                <div class="row mb-3">
                    ...
                    <!-- Phương tiện khác -->
                    <div class="col-md-6">
                        <label for="ptkhac" class="form-label"><b>Mô tả phương tiện khác</b></label>
                ...
                <!-- Xe công ty -->
                <div class="row mb-3">
                    <label for="ApplyCar" class="form-label"><b>Xe công ty</b></label>
