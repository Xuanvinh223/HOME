...
public partial class WKF_BusinessTrip_List : Ede.Uof.Utility.Page.BasePage
{
    ...
    protected void gvBT_BeforeExport(object sender, Ede.Uof.Utility.Component.BeforeExportEventArgs e)
    {
        ...
        List<string> excludedColumns = new List<string> { "Days", "TASK_ID", "RTASK_ID" };
        ...
        dtEXP.Columns.RemoveAt(dtEXP.Columns.Count - 5);
        dtEXP.Columns.RemoveAt(dtEXP.Columns.Count - 4);
